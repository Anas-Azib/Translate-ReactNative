...
export interface VadOptions {
   ...
   *
   * Long by design. This is not a cost control — silence never reaches a
   * provider, because the VAD only emits segments around detected speech — it
   * is purely a backstop against a microphone left open by accident. Making it
   * short punishes the normal case: people pause to think, to listen to the
   * reply, or to hand the phone over, and having the mic cut out mid-conversation
   * is far more annoying than a few extra minutes of an idle open stream.
   */
