...
export class ApiClient {
  ...
  /** The whole pipeline in one call: audio in, translation + speech out. */
  async translateSegment(input: {
    ...
    form.append('audio', input.audio, 'segment.webm');
    form.append('sessionId', input.sessionId);
    form.append('sourceLang', input.sourceLang);
    form.append('targetLang', input.targetLang);
    form.append('durationSeconds', String(input.durationSeconds));
    if (input.previousText) form.append('previousText', input.previousText);
    if (input.speak !== undefined) form.append('speak', String(input.speak));

    return this.#request<SegmentOutcome>('POST', '/translate/segment', form);
  }
  ...
  async speak(input: {
    ...
    return this.#request('POST', '/translate/speak', input);
  }
